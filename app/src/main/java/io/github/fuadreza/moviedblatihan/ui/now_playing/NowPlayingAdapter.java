...
import io.github.fuadreza.moviedblatihan.ui.search.SearchMovieAdapter;
...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.MovieViewHolder> {
    ...
    public NowPlayingAdapter(List<Movie> movies, NowPlayingView view) {
        this.movies = movies;
        this.view = view;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull NowPlayingAdapter.MovieViewHolder movieViewHolder, int i) {
